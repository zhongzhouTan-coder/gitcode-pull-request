...
import { CreateIssueCommentInput, CreateIssueCommentResult, DeleteIssueCommentInput, GitCodeRepository, IssueCommentDeleteOperation, IssueCommentsSnapshot } from '../../common/models';
