# list repo members API

## API Description

This API allows users to list members of a repository.
...
```bash
curl --request GET \
  --url 'https://api.gitcode.com/api/v5/repos/Ascend/MindStudio-ModelSlim/collaborators?access_token=xxxxxxxxxxxxx'
```
